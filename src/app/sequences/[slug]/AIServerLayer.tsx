    ...
    <Card className="w-full  mx-auto overflow-hidden">
      <CardHeader className="bg-gradient-to-b from-background to-secondary/20 text-center">
        ...
        <CardDescription className="mt-4 text-lg text-muted-foreground">
          Débloquez tout le potentiel de l&apos;IA dans votre enseignement avec
          ClasseGenius
        </CardDescription>
      </CardHeader>
      <CardContent className="p-6">
        <div className="grid md:grid-cols-2 gap-8">
          <Card>
            <CardHeader>
              ...
              <CardDescription className="text-lg">Essentiel</CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <Accordion type="single" collapsible className="mt-8">
          <AccordionItem value="faq-1">
            ...
            <AccordionContent>
              Nous prévoyons de lancer ces nouvelles fonctionnalités dans les
              prochains mois. Les utilisateurs de ClasseGenius seront les
              premiers à y avoir accès dès leur sortie.
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value="faq-2">
            <AccordionTrigger>
              Puis-je tester ces fonctionnalités avant de passer à l&apos;offre
              Expert ?
            </AccordionTrigger>
            <AccordionContent>
              Nous proposerons une période d&apos;essai limitée pour les
              utilisateurs de ClassePro afin qu&apos;ils puissent découvrir les
              avantages de l&apos;offre Expert avant de s&apos;engager.
            </AccordionContent>
          </AccordionItem>
        </Accordion>
      </CardContent>
      <CardFooter className="bg-gradient-to-b from-background to-secondary/20 p-6">
